...
function showTasks (shouldShow = false): void {
  console.log('show tasks', shouldShow)
  credentials.classList.toggle('hidden', shouldShow)
  tasks.classList.toggle('hidden', !shouldShow)
}
