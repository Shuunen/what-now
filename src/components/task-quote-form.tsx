 ...
 */
export function TaskQuoteForm({ form, onDelete, onUpdate, task }: TaskQuoteFormProps) {
  ...
  return (
    <div className="relative mt-4 animate-in overflow-hidden rounded-lg border border-gray-600/30 bg-gray-800/30 p-8 shadow-sm duration-500 fade-in slide-in-from-bottom-2" data-testid="task-quote-form">
      ...
      <span aria-hidden className="pointer-events-none absolute right-1 -bottom-20 font-serif text-9xl leading-none text-primary-accent select-none">
        ”
      </span>
    </div>
  )
